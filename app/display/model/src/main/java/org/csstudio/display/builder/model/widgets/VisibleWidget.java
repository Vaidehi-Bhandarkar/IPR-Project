...
//NEW
import static org.csstudio.display.builder.model.properties.CommonWidgetProperties.propTooltip1;
...
public class VisibleWidget extends Widget
{
    ...
    //NEW
    private WidgetProperty<String> tooltip1;
    ...
    protected void defineProperties(final List<WidgetProperty<?>> properties)
    {
        ...
        //NEW
        properties.add(tooltip1 = propTooltip1.createProperty(this, getInitialTooltip1()));
    ...
    //NEW
    /** @return Property 'tooltip' */
    public WidgetProperty<String> propTooltip1()
    {
        return tooltip1;
    }
