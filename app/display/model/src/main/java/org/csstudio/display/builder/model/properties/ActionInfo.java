//project/phoebus-master/app/display/model/src/main/java/org/csstudio/display/builder/model/properties/ActionInfo.java
...
public abstract class ActionInfo
{
    ...
    public enum ActionType
    {
        ...
        //NEW
        WRITE_PV1("Write PV1", "/icons/write_pv.png"),
    ...
    public static ActionInfo createAction(final ActionType type)
    {
        ...
        //NEW
        case WRITE_PV1:
            return new WritePV1ActionInfo(type.toString(), "$(pv1_name)", "0");
