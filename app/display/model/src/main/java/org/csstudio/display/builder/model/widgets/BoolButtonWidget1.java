//project/phoebus-master/app/display/model/src/main/java/org/csstudio/display/builder/model/widgets/BoolButtonWidget1.java
...
//NEW
import static org.csstudio.display.builder.model.properties.CommonWidgetProperties.propLabelsFromPV1;
...
public class BoolButtonWidget1 extends WriteReadPV
{
    /** Widget descriptor */
    public static final WidgetDescriptor WIDGET_DESCRIPTOR =
        new WidgetDescriptor("bool_button 1", WidgetCategory.CONTROL,
            "LED Boolean Button",
            "/icons/bool_button.png",
            "Button that can toggle two bits of a PV value between 1 and 0",
    ...
    private static class CustomConfigurator1 extends WidgetConfigurator
    {
        public CustomConfigurator1(Version xml_version)
        {
            super(xml_version);
        }
                ...
                throws Exception
        {
            ...
            {
                final BoolButtonWidget1 button = (BoolButtonWidget1) widget;
    ...
    //NEW
    private volatile WidgetProperty<Boolean> labels_from_pv1;
    ...
    public WidgetConfigurator getConfigurator(Version persisted_version)
            throws Exception
    {
        return new CustomConfigurator1(persisted_version);
    }
    ...
    protected void defineProperties(final List<WidgetProperty<?>> properties)
    {
        ...
        //NEW
        properties.add(labels_from_pv1 = propLabelsFromPV1.createProperty(this, false));
    ...
    //NEW
    /* @return 'labels_from_pv1' property */
    public WidgetProperty<Boolean> propLabelsFromPV1()
    {
        return labels_from_pv1;
    } 
}
