//project/phoebus-master/app/display/model/src/main/java/org/csstudio/display/builder/model/properties/CommonWidgetProperties.java
...
public class CommonWidgetProperties
{
    ...
    //NEW 
    public static final WidgetPropertyDescriptor<String> newPV1NamePropertyDescriptor(final WidgetPropertyCategory category,
            final String name, final String description)
	{
    	return new WidgetPropertyDescriptor<>(category, name, description)
    	{
    		...
    		public WidgetProperty<String> createProperty(final Widget widget, final String value)
    		{
    			return new PV1NameWidgetProperty(this, widget, value);
    		}
    	};
	}
    ...
    //NEW
    public static final WidgetPropertyDescriptor<String> propTooltip1 =
            new WidgetPropertyDescriptor<>(WidgetPropertyCategory.BEHAVIOR, "tooltip1", Messages.WidgetProperties_Tooltip)
    {
        @Override
        public WidgetProperty<String> createProperty(final Widget widget, final String value)
        {
    ...
    // New
    public static final WidgetPropertyDescriptor<Boolean> propLabelsFromPV1 =
            newBooleanPropertyDescriptor(WidgetPropertyCategory.DISPLAY, "labels_from_pv1", Messages.WidgetProperties_LabelsFromPV1);
    ...
    //NEW
    /** 'items_from_pv1' property: If PV1 is enum PV1, get items from PV1? */
    public static final WidgetPropertyDescriptor<Boolean> propItemsFromPV1 =
        CommonWidgetProperties.newBooleanPropertyDescriptor(WidgetPropertyCategory.BEHAVIOR, "items_from_pv1", Messages.WidgetProperties_ItemsFromPV1);
    ...
    //NEW
    /** 'pv_name' property: Secondary PV Name */
    public static final WidgetPropertyDescriptor<String> propPV1Name =
            newPV1NamePropertyDescriptor(WidgetPropertyCategory.WIDGET, "pv1_name", Messages.WidgetProperties_PV1Name);
    ...
    //NEW
    /** 'limits_from_pv1' property: Use limits from PV1's meta data? */
    public static final WidgetPropertyDescriptor<Boolean> propLimitsFromPV1 =
            newBooleanPropertyDescriptor(WidgetPropertyCategory.BEHAVIOR, "limits_from_pv1", Messages.WidgetProperties_LimitsFromPV1);
    ...
    //NEW
    /** Runtime 'pv1_value' property: Typically read from secondary PV */
    public static final WidgetPropertyDescriptor<VType> runtimePropPV1Value =
            newRuntimeValue("pv1_value", Messages.WidgetProperties_Value1);
    ...
    //NEW
    /** Runtime 'pv1_writable' property: Does secondary PV have write access? */
    public static final WidgetPropertyDescriptor<Boolean> runtimePropPV1Writable =
            newBooleanPropertyDescriptor(WidgetPropertyCategory.RUNTIME, "pv1_writable", Messages.WidgetProperties_Writable);
