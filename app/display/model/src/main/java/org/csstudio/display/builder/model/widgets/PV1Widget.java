//project/phoebus-master/app/display/model/src/main/java/org/csstudio/display/builder/model/widgets/PV1Widget.java
...
//NEW
import static org.csstudio.display.builder.model.properties.CommonWidgetProperties.propPV1Name;
...
public class PV1Widget extends VisibleWidget
{
    ...
    //NEW
    public static final VType RUNTIME_VALUE_NO_PV1 = VString.of(Messages.ValueNoPV,
            Alarm.of(AlarmSeverity.NONE, AlarmStatus.CLIENT, Messages.ValueNoPV),
            Time.of(Instant.ofEpochSecond(0), 0, false));
    ...
    //NEW
    private volatile WidgetProperty<String> pv1_name;
    private volatile WidgetProperty<VType>  pv1_value;
    
    private volatile WidgetProperty<Boolean> alarm_border;


    /** @param type Widget type. */
    public PV1Widget(final String type)
    {
        super(type);
    }
     ...
     */
    public PV1Widget(final String type, final int default_width, final int default_height)
    {
    ...
    protected void defineProperties (final List<WidgetProperty<?>> properties )
    {
        ...
        //NEW
        properties.add(pv1_name = propPV1Name.createProperty(this, ""));
        properties.add(pv1_value = runtimePropPV1Value.createProperty(this, null));
    ...
    //NEW 
    @Override
    protected String getInitialTooltip1()
    {
        // PV-based widgets shows the PV and value
        return "$(pv1_name)\n$(pv1_value)";
    }
    ...
    //NEW
    /** @return 'pv1_name' property */
    public final WidgetProperty<String> propPV1Name()
    {
        return pv1_name;
    }
    ...
    //NEW
    /** @return Runtime 'pv1_value' property */
    public WidgetProperty<VType> runtimePropPV1Value()
    {
        return pv1_value;
    }
