...
import org.csstudio.display.builder.model.widgets.BoolButtonWidget1;
import org.csstudio.display.builder.model.widgets.BoolButtonWidget1.Mode;
...
public class BoolButtonRepresentation1 extends RegionBaseRepresentation<Pane, BoolButtonWidget1>
{
    ...
    //NEW
    private final WidgetPropertyListener<Boolean> enablementChangedListener1 = this::enablementChanged;
    ...
    protected void registerListeners()
    {
        ...
        //NEW
        model_widget.runtimePropPV1Writable().addPropertyListener(enablementChangedListener1);
    ...
    protected void unregisterListeners()
    {
        ...
        //NEW 
        model_widget.runtimePropPV1Writable().removePropertyListener(enablementChangedListener1);
    ...
    public void updateChanges()
    {
        ...
        if (dirty_enablement.checkAndClear())
        {
            final boolean enabled = model_widget.propEnabled().getValue()  &&
                                    ...
                                    model_widget.runtimePropPV1Writable().getValue();
