//project/phoebus-master/app/display/representation-javafx/src/main/java/org/csstudio/display/builder/representation/javafx/Messages.java
...
public class Messages
{
    ...
    //NEW
    public static String ActionsDialog_PV1Name;
